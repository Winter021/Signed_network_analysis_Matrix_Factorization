...
def sl_graph_kernel(adj_matrix, kernel_type = "signed_resistance", regularization = 0.1):
  ...
  if kernel_type == "signed_resistance":
    ...
    print (kernel_matrix)
  elif kernel_type == "regularized_laplacian":
  ...
  elif kernel_type == "heat_diffusion":
...
#TODO SWEng this code == duplicated in moi, hoc kfold CV split
